...
consists of ai.viXra:2512.0060, 0061, 0064, 0070, all at v2 (2026), each with
an exact verification suite; papers, scripts, and reference logs are
distributed in a single companion repository. This note is the map.}}
\end{center}
...
Four manuscripts address different parts of this question: algebraic
...
and its proxy pathologies \cite{HCut}, and a Davies-class stress test with
ceiling/floor envelopes \cite{Stress}. The purpose of this note is to make the
